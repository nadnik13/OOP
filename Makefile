#############################################################################
# Makefile for building: OOP
# Generated by qmake (3.1) (Qt 5.9.2)
# Project:  ../progect/OOP.pro
# Template: app
# Command: /home/nadya/Qt/5.9.2/gcc_64/bin/qmake -o Makefile ../progect/OOP.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I../progect -I. -I../../../Qt/5.9.2/gcc_64/include -I../../../Qt/5.9.2/gcc_64/include/QtCore -I. -I../../../Qt/5.9.2/gcc_64/mkspecs/linux-g++
QMAKE         = /home/nadya/Qt/5.9.2/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/nadya/Qt/5.9.2/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/nadya/Qt/5.9.2/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
...
COMPRESS      = gzip -9f
DISTNAME      = OOP1.0.0
DISTDIR = /home/nadya/Документы/OOP/build-OOP-Desktop_Qt_5_9_2_GCC_64bit-Debug/.tmp/OOP1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/nadya/Qt/5.9.2/gcc_64/lib
LIBS          = $(SUBLIBS) -L/home/nadya/Qt/5.9.2/gcc_64/lib -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = ../Документы/OOP/main.cpp \
...
DIST          = ../../../Qt/5.9.2/gcc_64/mkspecs/features/spec_pre.prf \
		...
		../progect/OOP.pro ../Документы/OOP/THexagon.h \
		...
		../Документы/OOP/TIterator.h ../Документы/OOP/main.cpp \
		../Документы/OOP/THexagon.cpp \
		../Документы/OOP/TOctergon.cpp \
		../Документы/OOP/Tree.cpp \
		../Документы/OOP/TreeItem.cpp \
...
Makefile: ../progect/OOP.pro ../../../Qt/5.9.2/gcc_64/mkspecs/linux-g++/qmake.conf ../../../Qt/5.9.2/gcc_64/mkspecs/features/spec_pre.prf \
		../../../Qt/5.9.2/gcc_64/mkspecs/common/unix.conf \
		../../../Qt/5.9.2/gcc_64/mkspecs/common/linux.conf \
		../../../Qt/5.9.2/gcc_64/mkspecs/common/sanitize.conf \
		../../../Qt/5.9.2/gcc_64/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile ../progect/OOP.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents ../Документы/OOP/THexagon.h ../Документы/OOP/TOctergon.h ../Документы/OOP/Tree.h ../Документы/OOP/TreeItem.h ../Документы/OOP/TTriangle.h ../Документы/OOP/IFigure.h ../Документы/OOP/IPolygon.h ../Документы/OOP/TIterator.h $(DISTDIR)/
	$(COPY_FILE) --parents ../Документы/OOP/main.cpp ../Документы/OOP/THexagon.cpp ../Документы/OOP/TOctergon.cpp ../Документы/OOP/Tree.cpp ../Документы/OOP/TreeItem.cpp ../Документы/OOP/TTriangle.cpp ../Документы/OOP/IPolygon.cpp $(DISTDIR)/
...
moc_predefs.h: ../../../Qt/5.9.2/gcc_64/mkspecs/features/data/dummy.cpp
	g++ -pipe -g -std=gnu++11 -Wall -W -dM -E -o moc_predefs.h ../../../Qt/5.9.2/gcc_64/mkspecs/features/data/dummy.cpp
...
main.o: ../Документы/OOP/main.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o ../Документы/OOP/main.cpp

THexagon.o: ../Документы/OOP/THexagon.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o THexagon.o ../Документы/OOP/THexagon.cpp

TOctergon.o: ../Документы/OOP/TOctergon.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o TOctergon.o ../Документы/OOP/TOctergon.cpp

Tree.o: ../Документы/OOP/Tree.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Tree.o ../Документы/OOP/Tree.cpp

TreeItem.o: ../Документы/OOP/TreeItem.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o TreeItem.o ../Документы/OOP/TreeItem.cpp

TTriangle.o: ../Документы/OOP/TTriangle.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o TTriangle.o ../Документы/OOP/TTriangle.cpp

IPolygon.o: ../Документы/OOP/IPolygon.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o IPolygon.o ../Документы/OOP/IPolygon.cpp
